...
// ExportRollbackStateCmd dumps app state to JSON that can start producing blocks again by removing upgrade plan
func ExportRollbackStateCmd(appExporter types.AppExporter, defaultNodeHome string) *cobra.Command {
	cmd := &cobra.Command{
		Use:   "export-rollback",
