...
sekaid tx multistaking upsert-staking-pool kiravaloper1627a906y9qqakqurrpru5kxmnr50uec8zall3m --from=validator --keyring-backend=test --fees=100ukex --chain-id=testing -y --broadcast-mode=block
sekaid tx multistaking delegate kiravaloper1627a906y9qqakqurrpru5kxmnr50uec8zall3m 1000000ukex --from=validator --keyring-backend=test --fees=100ukex --chain-id=testing -y --broadcast-mode=block
sekaid tx multistaking undelegate kiravaloper1627a906y9qqakqurrpru5kxmnr50uec8zall3m 10000ukex --from=validator --keyring-backend=test --fees=100ukex --chain-id=testing -y --broadcast-mode=block
