...
sekaid tx customgov proposal set-network-property UNJAIL_MAX_TIME 1440  --title="title" --description="description" --from=validator --keyring-backend=test --home=$HOME/.sekaid --chain-id=testing --fees=100ukex --yes