...
sekaid tx customgov proposal role blacklist-permission newrole $PermVoteUpsertDataRegistryProposal  --title="title" --description="description" --from=validator --keyring-backend=test --home=$HOME/.sekaid --chain-id=testing --fees=100ukex --yes
