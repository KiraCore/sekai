...
sekaid tx customgov proposal role remove-whitelisted-permission newrole $PermCreateUpsertDataRegistryProposal  --title="title" --description="description" --from=validator --keyring-backend=test --home=$HOME/.sekaid --chain-id=testing --fees=100ukex --yes
