...
var (
	...
	ErrAmountBelowBaksetMintsMin      = errors.Register(ModuleName, 12, "mints amount is below basket minimum")
	ErrAmountAboveBaksetMintsMax      = errors.Register(ModuleName, 13, "mints amount is above basket maximum for the period")
	ErrAmountBelowBaksetBurnsMin      = errors.Register(ModuleName, 14, "burns amount is below basket minimum")
	ErrAmountAboveBaksetBurnsMax      = errors.Register(ModuleName, 15, "burns amount is above basket maximum for the period")
	ErrAmountBelowBaksetSwapsMin      = errors.Register(ModuleName, 16, "swaps amount is below basket minimum")
