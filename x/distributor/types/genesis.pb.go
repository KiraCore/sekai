...
func (m *YearStartSnapshot) Reset()         { *m = YearStartSnapshot{} }
func (m *YearStartSnapshot) String() string { return proto.CompactTextString(m) }
func (*YearStartSnapshot) ProtoMessage()    {}
func (*YearStartSnapshot) Descriptor() ([]byte, []int) {
	return fileDescriptor_e815530f0f0e0b78, []int{1}
}
func (m *YearStartSnapshot) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *YearStartSnapshot) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_YearStartSnapshot.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *YearStartSnapshot) XXX_Merge(src proto.Message) {
	xxx_messageInfo_YearStartSnapshot.Merge(m, src)
}
func (m *YearStartSnapshot) XXX_Size() int {
	return m.Size()
}
func (m *YearStartSnapshot) XXX_DiscardUnknown() {
	xxx_messageInfo_YearStartSnapshot.DiscardUnknown(m)
}

var xxx_messageInfo_YearStartSnapshot proto.InternalMessageInfo

func (m *YearStartSnapshot) GetSnapshotTime() int64 {
	if m != nil {
...
type GenesisState struct {
	...
	// year start snapshot
	YearStartSnapshot YearStartSnapshot `protobuf:"bytes,6,opt,name=year_start_snapshot,json=yearStartSnapshot,proto3" json:"year_start_snapshot"`
}
...
func (m *GenesisState) GetYearStartSnapshot() YearStartSnapshot {
	if m != nil {
...
func init() {
	...
	proto.RegisterType((*YearStartSnapshot)(nil), "kira.distributor.YearStartSnapshot")
...
var fileDescriptor_e815530f0f0e0b78 = []byte{
	...
	,
}
...
func (m *YearStartSnapshot) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *YearStartSnapshot) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *YearStartSnapshot) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *YearStartSnapshot) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *YearStartSnapshot) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: YearStartSnapshot: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: YearStartSnapshot: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
