...
var _ sdk.Msg = &MsgJoinDappTx{}

func (m *MsgJoinDappTx) Route() string {
	return ModuleName
}
func (m *MsgJoinDappTx) Type() string {
	return types.MsgTypeJoinDappTx
}
func (m *MsgJoinDappTx) ValidateBasic() error {
	_, err := sdk.AccAddressFromBech32(m.Sender)
	if err != nil {
		return err
	}
...
func (m *MsgJoinDappTx) GetSignBytes() []byte {
	bz := ModuleCdc.MustMarshalJSON(m)
	return sdk.MustSortJSON(bz)
}
func (m *MsgJoinDappTx) GetSigners() []sdk.AccAddress {
	addr, err := sdk.AccAddressFromBech32(m.Sender)
	if err != nil {
		panic(err)
	}
...
var _ sdk.Msg = &MsgVoteDappOperatorTx{}

func (m *MsgVoteDappOperatorTx) Route() string {
	return ModuleName
}
func (m *MsgVoteDappOperatorTx) Type() string {
	return types.MsgTypeVoteDappOperatorTx
}
func (m *MsgVoteDappOperatorTx) ValidateBasic() error {
	_, err := sdk.AccAddressFromBech32(m.Sender)
	if err != nil {
		return err
	}
...
func (m *MsgVoteDappOperatorTx) GetSignBytes() []byte {
	bz := ModuleCdc.MustMarshalJSON(m)
	return sdk.MustSortJSON(bz)
}
func (m *MsgVoteDappOperatorTx) GetSigners() []sdk.AccAddress {
	addr, err := sdk.AccAddressFromBech32(m.Sender)
	if err != nil {
		panic(err)
	}
...
var _ sdk.Msg = &MsgUpsertDappProposalTx{}

func (m *MsgUpsertDappProposalTx) Route() string {
	return ModuleName
}
func (m *MsgUpsertDappProposalTx) Type() string {
	return types.MsgTypeUpsertDappProposalTx
}
func (m *MsgUpsertDappProposalTx) ValidateBasic() error {
	_, err := sdk.AccAddressFromBech32(m.Sender)
	if err != nil {
		return err
	}
...
func (m *MsgUpsertDappProposalTx) GetSignBytes() []byte {
	bz := ModuleCdc.MustMarshalJSON(m)
	return sdk.MustSortJSON(bz)
}
func (m *MsgUpsertDappProposalTx) GetSigners() []sdk.AccAddress {
	addr, err := sdk.AccAddressFromBech32(m.Sender)
	if err != nil {
		panic(err)
	}
...
var _ sdk.Msg = &MsgVoteUpsertDappProposalTx{}

func (m *MsgVoteUpsertDappProposalTx) Route() string {
	return ModuleName
}
func (m *MsgVoteUpsertDappProposalTx) Type() string {
	return types.MsgTypeVoteUpsertDappProposalTx
}
func (m *MsgVoteUpsertDappProposalTx) ValidateBasic() error {
	_, err := sdk.AccAddressFromBech32(m.Sender)
	if err != nil {
		return err
	}
...
func (m *MsgVoteUpsertDappProposalTx) GetSignBytes() []byte {
	bz := ModuleCdc.MustMarshalJSON(m)
	return sdk.MustSortJSON(bz)
}
func (m *MsgVoteUpsertDappProposalTx) GetSigners() []sdk.AccAddress {
	addr, err := sdk.AccAddressFromBech32(m.Sender)
	if err != nil {
		panic(err)
	}
