...
type ValidatorSigningInfo struct {
	...
	StartHeight         int64           `json:"start_height" yaml:"start_height"`                   // height at which validator was first a candidate OR was activated
	IndexOffset         int64           `json:"index_offset" yaml:"index_offset"`                   // index offset into signed block bit array
	InactiveUntil       time.Time       `json:"inactivated_until" yaml:"inactivated_until"`         // timestamp validator cannot be activated until
