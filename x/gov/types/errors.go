...
var (
	...
	ErrInvalidRoleIdentifier          = errors.Register(ModuleName, 47, "invalid role identifier")
	ErrProposalTitleSizeExceeds       = errors.Register(ModuleName, 48, "proposal title size exceeds")
	ErrProposalDescriptionSizeExceeds = errors.Register(ModuleName, 49, "proposal description size exceeds")
	ErrProposalReferenceSizeExceeds   = errors.Register(ModuleName, 50, "proposal reference size exceeds")
	ErrProposalChecksumSizeExceeds    = errors.Register(ModuleName, 51, "proposal checksum size exceeds")
	ErrProposalOptionCountExceeds     = errors.Register(ModuleName, 52, "proposal option count exceeds")
