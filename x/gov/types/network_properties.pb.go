...
const (
	...
	MaxProposalTitleSize        NetworkProperty = 33
	MaxProposalDescriptionSize  NetworkProperty = 34
	MaxProposalPollOptionSize   NetworkProperty = 35
	MaxProposalPollOptionCount  NetworkProperty = 36
	MaxProposalReferenceSize    NetworkProperty = 37
	MaxProposalChecksumSize     NetworkProperty = 38
)
...
var NetworkProperty_name = map[int32]string{
	...
	33: "MAX_PROPOSAL_TITLE_SIZE",
	34: "MAX_PROPOSAL_DESCRIPTION_SIZE",
	35: "MAX_PROPOSAL_POLL_OPTION_SIZE",
	36: "MAX_PROPOSAL_POLL_OPTION_COUNT",
	37: "MAX_PROPOSAL_REFERENCE_SIZE",
	38: "MAX_PROPOSAL_CHECKSUM_SIZE",
}
...
var NetworkProperty_value = map[string]int32{
	...
	"MAX_PROPOSAL_TITLE_SIZE":        33,
	"MAX_PROPOSAL_DESCRIPTION_SIZE":  34,
	"MAX_PROPOSAL_POLL_OPTION_SIZE":  35,
	"MAX_PROPOSAL_POLL_OPTION_COUNT": 36,
	"MAX_PROPOSAL_REFERENCE_SIZE":    37,
	"MAX_PROPOSAL_CHECKSUM_SIZE":     38,
}
...
type NetworkProperties struct {
	...
	MaxProposalReferenceSize    uint64 `protobuf:"varint,37,opt,name=max_proposal_reference_size,json=maxProposalReferenceSize,proto3" json:"max_proposal_reference_size,omitempty"`
	MaxProposalChecksumSize     uint64 `protobuf:"varint,38,opt,name=max_proposal_checksum_size,json=maxProposalChecksumSize,proto3" json:"max_proposal_checksum_size,omitempty"`
}
...
var fileDescriptor_98011a6048e5dde3 = []byte{
	...
	,
}
