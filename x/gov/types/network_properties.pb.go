...
const (
	...
	VoteQuorumShort             NetworkProperty = 3
	VoteQuorumLong              NetworkProperty = 4
	ProposalEndTime             NetworkProperty = 5
	ProposalEndTimeShort        NetworkProperty = 6
	ProposalEndTimeLong         NetworkProperty = 7
	ProposalEnactmentTime       NetworkProperty = 8
	MinProposalEndBlocks        NetworkProperty = 9
	MinProposalEnactmentBlocks  NetworkProperty = 10
	EnableForeignFeePayments    NetworkProperty = 11
	MischanceRankDecreaseAmount NetworkProperty = 12
	MaxMischance                NetworkProperty = 13
	MischanceConfidence         NetworkProperty = 14
	InactiveRankDecreasePercent NetworkProperty = 15
	PoorNetworkMaxBankSend      NetworkProperty = 16
	MinValidators               NetworkProperty = 17
	JailMaxTime                 NetworkProperty = 18
	EnableTokenWhitelist        NetworkProperty = 19
	EnableTokenBlacklist        NetworkProperty = 20
	MinIdentityApprovalTip      NetworkProperty = 21
	UniqueIdentityKeys          NetworkProperty = 22
)
...
var NetworkProperty_name = map[int32]string{
	...
	4:  "VOTE_QUORUM_LONG",
	5:  "PROPOSAL_END_TIME",
	6:  "PROPOSAL_END_TIME_SHORT",
	7:  "PROPOSAL_END_TIME_LONG",
	8:  "PROPOSAL_ENACTMENT_TIME",
	9:  "MIN_PROPOSAL_END_BLOCKS",
	10: "MIN_PROPOSAL_ENACTMENT_BLOCKS",
	11: "ENABLE_FOREIGN_FEE_PAYMENTS",
	12: "MISCHANCE_RANK_DECREASE_AMOUNT",
	13: "MAX_MISCHANCE",
	14: "MISCHANCE_CONFIDENCE",
	15: "INACTIVE_RANK_DECREASE_PERCENT",
	16: "POOR_NETWORK_MAX_BANK_SEND",
	17: "MIN_VALIDATORS",
	18: "JAIL_MAX_TIME",
	19: "ENABLE_TOKEN_WHITELIST",
	20: "ENABLE_TOKEN_BLACKLIST",
	21: "MIN_IDENTITY_APPROVAL_TIP",
	22: "UNIQUE_IDENTITY_KEYS",
}
...
var NetworkProperty_value = map[string]int32{
	...
	"VOTE_QUORUM_LONG":               4,
	"PROPOSAL_END_TIME":              5,
	"PROPOSAL_END_TIME_SHORT":        6,
	"PROPOSAL_END_TIME_LONG":         7,
	"PROPOSAL_ENACTMENT_TIME":        8,
	"MIN_PROPOSAL_END_BLOCKS":        9,
	"MIN_PROPOSAL_ENACTMENT_BLOCKS":  10,
	"ENABLE_FOREIGN_FEE_PAYMENTS":    11,
	"MISCHANCE_RANK_DECREASE_AMOUNT": 12,
	"MAX_MISCHANCE":                  13,
	"MISCHANCE_CONFIDENCE":           14,
	"INACTIVE_RANK_DECREASE_PERCENT": 15,
	"POOR_NETWORK_MAX_BANK_SEND":     16,
	"MIN_VALIDATORS":                 17,
	"JAIL_MAX_TIME":                  18,
	"ENABLE_TOKEN_WHITELIST":         19,
	"ENABLE_TOKEN_BLACKLIST":         20,
	"MIN_IDENTITY_APPROVAL_TIP":      21,
	"UNIQUE_IDENTITY_KEYS":           22,
}
...
type NetworkProperties struct {
	...
	VoteQuorumShort             uint64 `protobuf:"varint,4,opt,name=vote_quorum_short,json=voteQuorumShort,proto3" json:"vote_quorum_short,omitempty"`
	VoteQuorumLong              uint64 `protobuf:"varint,5,opt,name=vote_quorum_long,json=voteQuorumLong,proto3" json:"vote_quorum_long,omitempty"`
	ProposalEndTime             uint64 `protobuf:"varint,6,opt,name=proposal_end_time,json=proposalEndTime,proto3" json:"proposal_end_time,omitempty"`
	ProposalEndTimeShort        uint64 `protobuf:"varint,7,opt,name=proposal_end_time_short,json=proposalEndTimeShort,proto3" json:"proposal_end_time_short,omitempty"`
	ProposalEndTimeLong         uint64 `protobuf:"varint,8,opt,name=proposal_end_time_long,json=proposalEndTimeLong,proto3" json:"proposal_end_time_long,omitempty"`
	ProposalEnactmentTime       uint64 `protobuf:"varint,9,opt,name=proposal_enactment_time,json=proposalEnactmentTime,proto3" json:"proposal_enactment_time,omitempty"`
	MinProposalEndBlocks        uint64 `protobuf:"varint,10,opt,name=min_proposal_end_blocks,json=minProposalEndBlocks,proto3" json:"min_proposal_end_blocks,omitempty"`
	MinProposalEnactmentBlocks  uint64 `protobuf:"varint,11,opt,name=min_proposal_enactment_blocks,json=minProposalEnactmentBlocks,proto3" json:"min_proposal_enactment_blocks,omitempty"`
	EnableForeignFeePayments    bool   `protobuf:"varint,12,opt,name=enable_foreign_fee_payments,json=enableForeignFeePayments,proto3" json:"enable_foreign_fee_payments,omitempty"`
	MischanceRankDecreaseAmount uint64 `protobuf:"varint,13,opt,name=mischance_rank_decrease_amount,json=mischanceRankDecreaseAmount,proto3" json:"mischance_rank_decrease_amount,omitempty"`
	MaxMischance                uint64 `protobuf:"varint,14,opt,name=max_mischance,json=maxMischance,proto3" json:"max_mischance,omitempty"`
	MischanceConfidence         uint64 `protobuf:"varint,15,opt,name=mischance_confidence,json=mischanceConfidence,proto3" json:"mischance_confidence,omitempty"`
	InactiveRankDecreasePercent uint64 `protobuf:"varint,16,opt,name=inactive_rank_decrease_percent,json=inactiveRankDecreasePercent,proto3" json:"inactive_rank_decrease_percent,omitempty"`
	MinValidators               uint64 `protobuf:"varint,17,opt,name=min_validators,json=minValidators,proto3" json:"min_validators,omitempty"`
	PoorNetworkMaxBankSend      uint64 `protobuf:"varint,18,opt,name=poor_network_max_bank_send,json=poorNetworkMaxBankSend,proto3" json:"poor_network_max_bank_send,omitempty"`
	JailMaxTime                 uint64 `protobuf:"varint,19,opt,name=jail_max_time,json=jailMaxTime,proto3" json:"jail_max_time,omitempty"`
	EnableTokenWhitelist        bool   `protobuf:"varint,20,opt,name=enable_token_whitelist,json=enableTokenWhitelist,proto3" json:"enable_token_whitelist,omitempty"`
	EnableTokenBlacklist        bool   `protobuf:"varint,21,opt,name=enable_token_blacklist,json=enableTokenBlacklist,proto3" json:"enable_token_blacklist,omitempty"`
	MinIdentityApprovalTip      uint64 `protobuf:"varint,22,opt,name=min_identity_approval_tip,json=minIdentityApprovalTip,proto3" json:"min_identity_approval_tip,omitempty"`
	UniqueIdentityKeys          string `protobuf:"bytes,23,opt,name=unique_identity_keys,json=uniqueIdentityKeys,proto3" json:"unique_identity_keys,omitempty"`
}
...
func (m *NetworkProperties) GetVoteQuorumShort() uint64 {
	if m != nil {
		return m.VoteQuorumShort
	}
	return 0
}

func (m *NetworkProperties) GetVoteQuorumLong() uint64 {
	if m != nil {
		return m.VoteQuorumLong
	}
	return 0
}
...
func (m *NetworkProperties) GetProposalEndTimeShort() uint64 {
	if m != nil {
		return m.ProposalEndTimeShort
	}
	return 0
}

func (m *NetworkProperties) GetProposalEndTimeLong() uint64 {
	if m != nil {
		return m.ProposalEndTimeLong
	}
	return 0
}
...
var fileDescriptor_98011a6048e5dde3 = []byte{
	...
	,
}
...
func (m *NetworkProperties) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.ProposalEndTimeLong != 0 {
		i = encodeVarintNetworkProperties(dAtA, i, uint64(m.ProposalEndTimeLong))
		i--
		dAtA[i] = 0x40
	}
	if m.ProposalEndTimeShort != 0 {
		i = encodeVarintNetworkProperties(dAtA, i, uint64(m.ProposalEndTimeShort))
		i--
		dAtA[i] = 0x38
	}
	...
	if m.VoteQuorumLong != 0 {
		i = encodeVarintNetworkProperties(dAtA, i, uint64(m.VoteQuorumLong))
		i--
		dAtA[i] = 0x28
	}
	if m.VoteQuorumShort != 0 {
		i = encodeVarintNetworkProperties(dAtA, i, uint64(m.VoteQuorumShort))
		i--
		dAtA[i] = 0x20
	}
	if m.VoteQuorum != 0 {
...
func (m *NetworkProperties) Size() (n int) {
	...
	if m.VoteQuorumShort != 0 {
		n += 1 + sovNetworkProperties(uint64(m.VoteQuorumShort))
	}
	if m.VoteQuorumLong != 0 {
		n += 1 + sovNetworkProperties(uint64(m.VoteQuorumLong))
	}
	if m.ProposalEndTime != 0 {
		n += 1 + sovNetworkProperties(uint64(m.ProposalEndTime))
	}
	if m.ProposalEndTimeShort != 0 {
		n += 1 + sovNetworkProperties(uint64(m.ProposalEndTimeShort))
	}
	if m.ProposalEndTimeLong != 0 {
		n += 1 + sovNetworkProperties(uint64(m.ProposalEndTimeLong))
	}
	if m.ProposalEnactmentTime != 0 {
	...
	if m.InactiveRankDecreasePercent != 0 {
		n += 2 + sovNetworkProperties(uint64(m.InactiveRankDecreasePercent))
	}
	if m.MinValidators != 0 {
		n += 2 + sovNetworkProperties(uint64(m.MinValidators))
	}
	if m.PoorNetworkMaxBankSend != 0 {
		n += 2 + sovNetworkProperties(uint64(m.PoorNetworkMaxBankSend))
	}
	if m.JailMaxTime != 0 {
...
func (m *NetworkProperties) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field VoteQuorumShort", wireType)
			}
			m.VoteQuorumShort = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.VoteQuorumShort |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 5:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field VoteQuorumLong", wireType)
			}
			m.VoteQuorumLong = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.VoteQuorumLong |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		...
		case 7:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ProposalEndTimeShort", wireType)
			}
			m.ProposalEndTimeShort = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowNetworkProperties
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ProposalEndTimeShort |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 8:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ProposalEndTimeLong", wireType)
			}
			m.ProposalEndTimeLong = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowNetworkProperties
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ProposalEndTimeLong |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
