...
type GenesisState struct {
	...
	NetworkProperties           *govtypes.NetworkProperties            `protobuf:"bytes,4,opt,name=network_properties,json=networkProperties,proto3" json:"network_properties,omitempty"`
...
func (m *GenesisState) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			if m.NetworkProperties == nil {
				m.NetworkProperties = &govtypes.NetworkProperties{}
			}
