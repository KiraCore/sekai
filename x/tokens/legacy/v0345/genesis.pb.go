...
type GenesisStateV0345 struct {
	...
	TokenBlackWhites *TokensWhiteBlackV0345 `protobuf:"bytes,3,opt,name=tokenBlackWhites,proto3" json:"tokenBlackWhites,omitempty"`
}

func (m *GenesisStateV0345) Reset()         { *m = GenesisStateV0345{} }
func (m *GenesisStateV0345) String() string { return proto.CompactTextString(m) }
func (*GenesisStateV0345) ProtoMessage()    {}
func (*GenesisStateV0345) Descriptor() ([]byte, []int) {
	return fileDescriptor_d3cbd9121e22d5d1, []int{0}
}
func (m *GenesisStateV0345) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *GenesisStateV0345) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_GenesisStateV0345.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
...
func (m *GenesisStateV0345) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GenesisStateV0345.Merge(m, src)
}
func (m *GenesisStateV0345) XXX_Size() int {
	return m.Size()
}
func (m *GenesisStateV0345) XXX_DiscardUnknown() {
	xxx_messageInfo_GenesisStateV0345.DiscardUnknown(m)
}

var xxx_messageInfo_GenesisStateV0345 proto.InternalMessageInfo

func (m *GenesisStateV0345) GetAliases() []*TokenAlias {
	if m != nil {
		return m.Aliases
	}
	return nil
...
func (m *GenesisStateV0345) GetRates() []*TokenRate {
	if m != nil {
		return m.Rates
	}
	return nil
...
func (m *GenesisStateV0345) GetTokenBlackWhites() *TokensWhiteBlackV0345 {
	if m != nil {
...
func init() {
	proto.RegisterType((*GenesisStateV0345)(nil), "kira.tokens.GenesisStateV0345")
}
...
func (m *GenesisStateV0345) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
...
func (m *GenesisStateV0345) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *GenesisStateV0345) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *GenesisStateV0345) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *GenesisStateV0345) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		if wireType == 4 {
			return fmt.Errorf("proto: GenesisStateV0345: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: GenesisStateV0345: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 3:
			...
			if m.TokenBlackWhites == nil {
				m.TokenBlackWhites = &TokensWhiteBlackV0345{}
			}
