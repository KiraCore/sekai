...
type AllTokenInfosResponse struct {
	Data []*TokenInfo `protobuf:"bytes,1,rep,name=data,proto3" json:"data,omitempty"`
}
...
func (m *AllTokenInfosResponse) GetData() []*TokenInfo {
	if m != nil {
		return m.Data
	}
	return nil
...
type TokenInfosByDenomResponse struct {
	Data map[string]*TokenInfo `protobuf:"bytes,1,rep,name=data,proto3" json:"data,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (m *TokenInfosByDenomResponse) GetData() map[string]*TokenInfo {
	if m != nil {
		return m.Data
	}
	return nil
...
func init() {
	...
	proto.RegisterMapType((map[string]*TokenInfo)(nil), "kira.tokens.TokenInfosByDenomResponse.DataEntry")
...
var fileDescriptor_c8db6e46fba94960 = []byte{
	...
	,
}
...
func (m *AllTokenInfosResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.Data = append(m.Data, &TokenInfo{})
...
func (m *TokenInfosByDenomResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.Data == nil {
				m.Data = make(map[string]*TokenInfo)
			}
			var mapkey string
