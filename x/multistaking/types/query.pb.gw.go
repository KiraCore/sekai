...
var (
	...
	pattern_Query_Delegations_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"kira", "multistaking", "v1beta1", "delegations"}, "", runtime.AssumeColonVerbOpt(true)))
